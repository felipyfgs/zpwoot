...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/sessions/{sessionId}/send/message/buttons": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Buttons message data",
                        "name": "message",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/SendButtonsMessageRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/sessions/{sessionId}/send/message/list": {
            "post": {
        ...
        "/sessions/{sessionId}/send/message/poll": {
            "post": {
                "description": "Send a poll/survey with multiple options to a WhatsApp contact",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "description": "Poll message data (2-12 options)",
                        "name": "message",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/sessions/{sessionId}/send/message/template": {
            "post": {
    ...
    "definitions": {
        ...
        "SendListMessageRequest": {
            ...
            "properties": {
                ...
                "text": {
                    "type": "string",
                    "example": "Please select an option from the list"
                },
                "title": {
                    "type": "string",
